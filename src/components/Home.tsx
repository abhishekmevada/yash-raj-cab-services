        ...
        <div className="fxya">
          ...
          {/* <div className="footerBoxc">
            ...
            <form action="" className="formCon">
              <label htmlFor="a">Pick Up Location</label>
              <input type="text" id="a" className="formInput" required />
              <label htmlFor="b">Pick Up Date</label>
              <input
                type="datetime-local"
                className="formInput"
                id="b"
                required
              />
              <label htmlFor="c">Drop Off Location</label>
              <input type="text" className="formInput" id="c" required />
              <label htmlFor="d">Drop Off Date</label>
              <input
                type="datetime-local"
                className="formInput"
                id="d"
